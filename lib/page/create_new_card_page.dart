...
import 'package:student_app/bloc/new_cards_bloc.dart';
...
class CreateNewCardPage extends StatelessWidget {
  CreateNewCardPage({Key? key}) : super(key: key);
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Selector<NewCardsBloc, NewCardsBloc>(
                          ...
                          showDialog(
                              ...
                              builder: (context) {
                                return const AlertDialog(
                                  title: Text(sorry),
                                  content:
                                      Text(pleaseCheckAndFillCardInformation),
                                );
                              });
                        } else {
                          bloc.onTapCreateNewCard(
